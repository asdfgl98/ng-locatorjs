...
exports.VOID_ELEMENTS = exports.SKIP_TAGS = void 0;
exports.findOpeningTags = findOpeningTags;
 ...
 */
function findOpeningTags(template) {
    const results = [];
 ...
 */
function isInsideComment(template, index) {
    let i = 0;
    while (i < index) {
