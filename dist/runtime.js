 ...
 */
function showTooltip(element, componentName, filePath) {
 ...
 */
function resolveClickedTagInfo(componentHost, target) {
 ...
 */
async function openComponent(componentName, targetTag, tagIndex = 0) {
 ...
 */
async function initializeComponentMap() {
 ...
 * ```
 */
export function installAngularLocator(userOptions = {}) {
 ...
 */
export function uninstallAngularLocator() {
    if (!isInitialized) {
        return;
    }
    deactivateHighlight();
